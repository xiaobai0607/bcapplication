...
import com.bootcamp.utils.tenpay.Sha1Util;
import com.bootcamp.utils.tenpay.TenpayUtil;
...
public class WechatPay {
	...
	public static String appid = "wx8c783fd770d4499e";
	public static String appsecret = "8a6a019a6296a49506c7cc1801fca6af";
	private static String partner = "1312013201";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "bootcamp05128166860660686618papi";
	//openId 是微信用户针对公众号的标识，授权的部分这里不解释
	private static String openId = "";
	//微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "http://www.bootcamp.org.cn/bootcamp/payback";																	 // Key
...
//		getCodeurl(tpWxPay1);
	...
	public static WechatPayEntity getPackage(WxPayDto tpWxPayDto) {
		...
		wechatPayEntity.setAppId(appid); 
		wechatPayEntity.setTimestamp(timestamp);
		wechatPayEntity.setPackageStr(packages);
		wechatPayEntity.setPaySign(finalsign);
		wechatPayEntity.setSignType("MD5");
		wechatPayEntity.setNonceStr(nonce_str);
