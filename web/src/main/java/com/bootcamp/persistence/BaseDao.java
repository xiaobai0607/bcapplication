...
import com.bootcamp.constant.BaseDaoConstant;
import com.bootcamp.utils.Reflections;
import com.bootcamp.utils.StringUtils;
...
//	        page.setCount(Long.valueOf(createQuery(countQlString, parameter).uniqueResult().toString()));
    ...
    @SuppressWarnings("unchecked")
    public List<T> getByHqlList(String qlString, Parameter parameter){
        Query query = createQuery(qlString, parameter);
        return query.list();
    }
...
//     */
    public int deleteById(Serializable id){
        return update("update "+entityClass.getSimpleName()+" set isDeleted ='" + BaseDaoConstant.DEL_FLAG_DELETE + "' where id = :p1",
                new Parameter(id));
    }
...
//     * @return
//     */
    public int resById(Serializable id){
        return update("update "+entityClass.getSimpleName()+" set isDeleted ='" + BaseDaoConstant.DEL_FLAG_NOT_DELETE + "' where id = :p1",
                new Parameter(id));
    }
//
//    /**
...
//    }
    ...
    public void deleteByIdPysical(Serializable obj){
